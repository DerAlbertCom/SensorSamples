...
namespace Windows7.Sensors
{
    ...
    public static class SensorManager
    {
        ...
        /// </summary>
        static readonly Dictionary<Guid, SensorTypeData> _guidToSensorDescr = new Dictionary<Guid, SensorTypeData>();

        /// <summary>
        ///     .NET type -> type GUID.
        /// </summary>
        static readonly Dictionary<Type, Guid> _sensorTypeToGuid = new Dictionary<Type, Guid>();

        static readonly ISensorManager _sensorMgr;
        static readonly SensorManagerEventSink _eventSink;
        ...
        {
            BuildSensorTypeMap();
            _sensorMgr = new Internal.SensorManager();
        ...
        ///     If no appropriate sensor wrapper type could be found, the object created will be of the base-class type
        ///     <see
        ///         cref="Sensor" />
        ///     .
        /// </summary>
        ...
        static Sensor GetSensorWrapperInstance(ISensor pSensor)
        {
            Guid sensorTypeGuid;
            ...
            var sensor = (Sensor) Activator.CreateInstance(sensorClassType);
        ...
        /// </summary>
        /// <param name="sensorCategory">
        ///     The category GUID. You can find a list of GUIDs in <see cref="SensorWrapper.SensorCategories" /> class.
        /// </param>
        ...
        public static Sensor[] GetSensorsByCategory(Guid sensorCategory)
        {
            ...
            if (sensorCollection != null)
            {
                ...
                var foundSensors = new Sensor[sensorCount];

                for (uint i = 0; i < sensorCount; i++)
                {
                    ISensor iSensor = null;
                    sensorCollection.GetAt(i, out iSensor);
                    foundSensors[i] = GetSensorWrapperInstance(iSensor);
                }
        ...
        /// </summary>
        /// <param name="sensorCategory">
        ///     The type GUID. You can find a list of GUIDs in <see cref="SensorWrapper.SensorTypes" /> class.
        /// </param>
        ...
        public static T[] GetSensorsByType<T>() where T : Sensor, new()
        {
            ...
            var castSensors = new T[sensors.Length];
        ...
        public static void RequestPermission(IntPtr parentWindow, bool modal, params Sensor[] sensors)
        {
            ...
            {
                sensorCollection.Add(sensor.InnerObject);
            }
