...
namespace Windows7.Location
{
    ...
    {
        ICivicAddressReport _civicAddressReport;

        public CivicAddressLocationReport()
        {
        }

        public CivicAddressLocationReport(string address1,
                                          string address2,
                                          string city,
        ...
        {
            var report = new DefaultCivicAddressReport(address1, address2, city, stateProvince, postalCode,
                                                       countryRegion);
