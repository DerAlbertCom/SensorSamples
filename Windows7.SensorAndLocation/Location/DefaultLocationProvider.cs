...
{
    /// <summary>
    ///     A base class for default event providers, e.g. <see cref="DefaultLatLongLocationProvider" /> and
    ///     <see
    ///         cref="DefaultCivicAddressLocationProvider" />
    ///     .
    /// </summary>
    public abstract class DefaultLocationProvider
    {
        ...
        static readonly IDefaultLocation _defaultLocation = new COMDefaultLocation();
        Guid _reportGuid;
